...
# we cant remove the last number in the set

friend_fav_numbers = [100, 200, 300, 100, 200, 300, 100, 200, 300, 100, 200, 300, 100, 200, 300, 100, 200, 300, 100,
                      200, 300]  # create a list with duplicates
friend_fav_numbers = set(friend_fav_numbers)

our_fav_numbers = my_fav_numbers.union(friend_fav_numbers)

# Exercise 2: Tuple
# nope, they are immutable
...
num = 0.5
list1 = [x + num for x in range(1000) if 0 < x <= 4]
list2 = [x for x in range(1000) if 1 < x <= 5]
list3 = list1 + list2
list3.sort()
print(list3)
